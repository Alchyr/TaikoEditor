...
public class StaminaEvaluator {
    ...
    public static double EvaluateDifficultyOf(DifficultyHitObject current)
    {
        ...
        TaikoDifficultyHitObject taikoPrevious = (TaikoDifficultyHitObject) current.previous(1);
    ...
    {
        DifficultyHitObject previousColourChange = hitObject.colourData.previousColorChange();
        DifficultyHitObject nextColourChange = hitObject.colourData.nextColorChange();
