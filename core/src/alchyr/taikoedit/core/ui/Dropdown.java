...
public class Dropdown<T> implements UIElement, Scrollable {
    private static final Color highlight = new Color(1.0f, 1.0f, 1.0f, 0.4f);
    ...
    public Dropdown(float leftX, float centerY, float width, float maxDropdownHeight, List<T> options, BitmapFont font) {
        this.font = font;
    ...
    public Dropdown(float leftX, float centerY, float width, int dropdownCount, List<T> options, BitmapFont font) {
        this.font = font;
    ...
    public Dropdown<T> setOption(T option) {
    ...
    public Dropdown<T> setOnSelect(BiConsumer<T, T> onSelect) {
