...
public final class Header {
    ...
    private byte syncmode = PreloadMp3Bitstream.INITIAL_SYNC;
    private Crc16 crc;
     ...
     */
    void read_header (PreloadMp3Bitstream stream, Crc16[] crcp) throws BitstreamException {
        int headerstring;
        int channel_bitrate;
        boolean sync = false;
        do {
            ...
            if (syncmode == PreloadMp3Bitstream.INITIAL_SYNC) {
            ...
            if (stream.isSyncCurrentPosition(syncmode)) {
                if (syncmode == PreloadMp3Bitstream.INITIAL_SYNC) {
                    syncmode = PreloadMp3Bitstream.STRICT_SYNC;
