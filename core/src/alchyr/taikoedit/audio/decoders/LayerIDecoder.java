 ...
 *
 * 12/12/99 Initial version. Adapted from javalayer.java and Subband.java. mdm@techie.com
 *
...
package alchyr.taikoedit.audio.decoders;

import alchyr.taikoedit.audio.PreloadMp3Bitstream;
...
public class LayerIDecoder implements FrameDecoder {
    protected PreloadMp3Bitstream stream;
    protected alchyr.taikoedit.audio.Header header;
    ...
    public void create (PreloadMp3Bitstream stream0, alchyr.taikoedit.audio.Header header0, SynthesisFilter filtera, SynthesisFilter filterb, OutputBuffer buffer0,
                        int which_ch0) {
        stream = stream0;
        header = header0;
        filter1 = filtera;
    ...
    static abstract class Subband {
        ...
        public abstract void read_allocation (PreloadMp3Bitstream stream, alchyr.taikoedit.audio.Header header, Crc16 crc) throws DecoderException;

        public abstract void read_scalefactor (PreloadMp3Bitstream stream, alchyr.taikoedit.audio.Header header);

        public abstract boolean read_sampledata (PreloadMp3Bitstream stream);
    ...
    static class SubbandLayer1 extends Subband {
         ...
         *
         */
        public void read_allocation (PreloadMp3Bitstream stream, alchyr.taikoedit.audio.Header header, Crc16 crc) throws DecoderException {
         ...
         *
         */
        public void read_scalefactor (PreloadMp3Bitstream stream, alchyr.taikoedit.audio.Header header) {
         ...
         *
         */
        public boolean read_sampledata (PreloadMp3Bitstream stream) {
