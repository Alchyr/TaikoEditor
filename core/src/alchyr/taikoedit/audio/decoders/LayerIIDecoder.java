...
public class LayerIIDecoder extends LayerIDecoder implements FrameDecoder {
    ...
    static class SubbandLayer2 extends Subband {
         ...
         *
         */
        protected int get_allocationlength (alchyr.taikoedit.audio.Header header) {
         ...
         *
         */
        protected void prepare_sample_reading (alchyr.taikoedit.audio.Header header, int allocation,
                                               // float[][] groupingtable,
         ...
         *
         */
        public void read_allocation (PreloadMp3Bitstream stream, alchyr.taikoedit.audio.Header header, Crc16 crc) {
         ...
         *
         */
        public void read_scalefactor_selection (PreloadMp3Bitstream stream, Crc16 crc) {
            if (allocation != 0) {
