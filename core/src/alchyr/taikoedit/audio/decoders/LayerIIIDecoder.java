...
public final class LayerIIIDecoder implements FrameDecoder {
    ...
    private alchyr.taikoedit.audio.Header header;
    ...
    public LayerIIIDecoder (PreloadMp3Bitstream stream0, alchyr.taikoedit.audio.Header header0, SynthesisFilter filtera, SynthesisFilter filterb, OutputBuffer buffer0,
                            int which_ch0) {
