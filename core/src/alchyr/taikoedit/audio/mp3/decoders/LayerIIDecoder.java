...
public class LayerIIDecoder extends LayerIDecoder implements FrameDecoder {
    ...
    static class SubbandLayer2 extends Subband {
         ...
         *
         */
        protected int get_allocationlength (alchyr.taikoedit.audio.mp3.Header header) {
         ...
         *
         */
        protected void prepare_sample_reading (alchyr.taikoedit.audio.mp3.Header header, int allocation,
                                               // float[][] groupingtable,
         ...
         *
         */
        public void read_allocation (PreloadMp3Bitstream stream, alchyr.taikoedit.audio.mp3.Header header, Crc16 crc) {
