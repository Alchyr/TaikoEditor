...
public class LayerIDecoder implements FrameDecoder {
    ...
    protected alchyr.taikoedit.audio.mp3.Header header;
    ...
    public void create (PreloadMp3Bitstream stream0, alchyr.taikoedit.audio.mp3.Header header0, SynthesisFilter filtera, SynthesisFilter filterb, OutputBuffer buffer0,
                        int which_ch0) {
        stream = stream0;
        header = header0;
        filter1 = filtera;
    ...
    static abstract class Subband {
        ...
        public abstract void read_allocation (PreloadMp3Bitstream stream, alchyr.taikoedit.audio.mp3.Header header, Crc16 crc) throws DecoderException;

        public abstract void read_scalefactor (PreloadMp3Bitstream stream, alchyr.taikoedit.audio.mp3.Header header);
    ...
    static class SubbandLayer1 extends Subband {
         ...
         *
         */
        public void read_allocation (PreloadMp3Bitstream stream, alchyr.taikoedit.audio.mp3.Header header, Crc16 crc) throws DecoderException {
         ...
         *
         */
        public void read_scalefactor (PreloadMp3Bitstream stream, alchyr.taikoedit.audio.mp3.Header header) {
